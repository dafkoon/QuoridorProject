...
//        players[id] = player;
//        this.ai = (id == 1) ? new AIController(id, this) : null;
//    }
...
//                VerticalWall secondWall = view.findVwall(row - 1, col);
//                view.colorVerticalWall(wall, secondWall, false);
//            }
//        }
//    }
...
//                VerticalWall secondWall = view.findVwall(row - 1, col);
//                view.decolorVerticalWall(wall, secondWall);
//            }
//        }
//    }
...
//                HorizontalWall secondWall = view.findHwall(row, col+1);
//                view.colorHorizontalWall(wall, secondWall, false);
//            }
//
//        }
//    }
...
//            if(!doesWallExist(wall.toAlgebraic(), true)) {
//                HorizontalWall secondWall = view.findHwall(row, col+1);
//                view.decolorHorizontalWall(wall, secondWall);
//
//            }
//        }
//    }
...
//                view.colorVerticalWall(wall1, wall2, true);
//            }
//        }
//    }
//
